...
def get_payment_confirmation_options():
	"""Modes of payment for portal confirm-payment (local Mode of Payment doctype)."""
	from bilan_sky.bilan_air_booking_system.utils.ba_settings_utils import get_ba_setting
	from bilan_sky.bilan_air_booking_system.utils.billing import list_enabled_modes_of_payment
	...
	modes = list_enabled_modes_of_payment()
	company = frappe.db.get_single_value("Global Defaults", "default_company")

	payload = {
		"remote": is_remote_accounting_enabled(),
		"company": company,
	...
	if payload["remote"]:
		config = remote_accounting_config() or {}
		payload["company"] = config.get("company") or company
