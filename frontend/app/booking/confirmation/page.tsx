      ...
      <div className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h1 className="text-navy font-serif text-4xl mb-4">Booking Confirmed!</h1>
            ...
            <div className="bg-white rounded-2xl border border-navy/10 overflow-hidden mb-8">
              ...
              <div className="p-6 space-y-4">
                <p className="text-sm">
                  ...
                  <span className="font-medium">{booking.status}</span> &middot;{' '}
                ...
                <div>
                  <p className="text-navy font-medium mb-2">Passengers</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline">
              <Link href={`/manage-booking?pnr=${encodeURIComponent(pnr)}`}>Manage Booking</Link>
            </Button>
          </div>
        </div>
      </div>
